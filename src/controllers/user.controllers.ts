...
export async function updateUserSocialMediaController(req: Request, res: Response) {
...
export async function updateUserProfilePictureController(req: Request, res: Response) {
    const user_id = req.user?.id;
    const file = req.file;
