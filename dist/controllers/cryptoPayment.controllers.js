...
import { spark_kiss_coins, ember_kiss_coins, inferno_kiss_coins } from "../constants/premium.js";
...
export async function handleKissCoinsCryptoPaymentCallbackController(req, res) {
    const rawBody = JSON.stringify(req.body);
    const incomingHmac = req.headers['hmac'];
    const secret = process.env.OXAPAY_API_KEY || '';
    // Validate HMAC signature
